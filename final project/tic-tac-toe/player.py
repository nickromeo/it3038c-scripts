...
class GeniusComputorPlayer(PlayerUno):
    def __init__(self, letter):
        super().__init__(letter)
    ...
    def minimax(self, state, player):
        ...
        #this is to check if the previous move was a winner by keeping track of the position and score
        ...
        for possible_move in state.available_move():
            ...
            # recurse using minimax to simulate that game after that move
            sim_score = self.minimax(state, other_player)  

            
            # undo the move if it wasent the most optimal
